package com.dliberty.recharge.common.mybatis.generator;
...
public class CodeGenerator {
	...
	public static void main(String[] args) {
		...
		String projectPath = System.getProperty("user.dir"); // 项目路径 （注意后面拼接
																// module 名称）
		String entityPackage = "com.dliberty.recharge.common.dao.entity"; // entity 文件生成包路径
		String mapperPackage = "com.dliberty.recharge.common.dao.mapper"; // mapper 文件生成包路径
		...
		strategy.setSuperMapperClass("com.dliberty.recharge.common.dao.base.BaseMapper");
