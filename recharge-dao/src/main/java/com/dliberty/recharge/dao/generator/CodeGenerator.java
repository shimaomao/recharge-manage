package com.dliberty.recharge.dao.generator;
...
public class CodeGenerator {
	...
	public static void main(String[] args) {
		...
		String projectPath = System.getProperty("user.dir"); // 项目路径 （注意后面拼接
																// module 名称）
		String entityPackage = "com.dliberty.recharge.dao.entity"; // entity 文件生成包路径
		String mapperPackage = "com.dliberty.recharge.dao.mapper"; // mapper 文件生成包路径
		String xmlPath = System.getProperty("user.dir") + "\\src\\main\\resources\\mapper"; // xml
																							// 文件生成位置
		String[] targetTables = { "tb_api_record","tb_recharge_card","tb_recharge_order","tb_sys_config" }; // 针对哪些表生成,null表示生成所有
		/*
		 * ----------------------------- end -----------------------------
		 */
		...
		strategy.setColumnNaming(NamingStrategy.underline_to_camel); // 列名
																		// 下划线转驼峰
		strategy.setSuperMapperClass("com.dliberty.recharge.common.mybatis.mapper.BaseMapper");
